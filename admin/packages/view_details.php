<?php 	include_once('../../config.php'); 
		...
		{     
			...
			mysql_query("update pck_list set approved = $_POST[approved]  where id=$_REQUEST[id] ");
					   ...
					   ?>
						<div class="content-box-large">
							<div class="panel-heading">  
								<div class="panel-title"> <h2> View Details</h2> </div>     
							...
							<div class="form-group"> 
							 ...
							 <hr>  
								...
								<div class="form-group"> 
								    ...
								    <div class="col-sm-10">
								      <?php echo $pck_details->st_price;?>  <img src="<?php echo ROOTPATH;?>/view/images/rupee_icon.png" />
								    </div> 
								 </div>
								 <hr>  	
								...
								<div class="form-group"> 
								    ...
								    <div class="col-sm-10">
								      <?php echo $pck_details->seller_name;?>
								    </div>  
								 </div>
								 <hr>    
						...
						<div class="content-box-large">
							<div class="panel-heading">  
							<div class="panel-title"> <h2> Other Details</h2> </div>   
							    
							</div>  
						 
							
			  				<div class="panel-body">  								 
			  					<form class="form-horizontal" method="post"  > <hr>    
								<div class="form-group"> 
								...
								<div class="form-group"> 
								 ...
								 <div class="form-group"> 
								    ...
								    <div class="col-sm-10">
								      <?php if($pck_info_data->is_active==1) echo 'Active'; else echo 'Inactive'; ?>
								    </div> 
								 </div>  
								 <hr> 		
								...
								<div class="form-group"> 
								    ...
								    <div class="col-sm-10">
									  ...
									  <option value="1" <?php if($pck_details->approved==1) echo 'selected=selected'; ?> >Approved</option>
									  <option value="0" <?php if($pck_details->approved==0) echo 'selected=selected'; ?> >Approval Pending</option>
									  </select>
								    </div>  
								 </div>	
								 <hr>
								  ...
								  <div class="form-group">  
								    <label for="inputEmail3" class="col-sm-2 control-label">Update Approval</label>
								    <div class="col-sm-10">
