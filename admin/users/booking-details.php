  					...
  					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
						...
						<tbody>
							<?php
								  ...
								  {  
									...
									if($row->type==1)
									{
										...
										while($myresult  = mysql_fetch_row($mys_result))
										{ 
							...
							<?php 
							  ...
							  if($row->type==3)
								{
									$mys_result = mysql_query("select   total_fare,booking_date from flight_details where 	payee_txn_id='$row->payee_txn_id'  ");
									while($myresult  = mysql_fetch_row($mys_result))
									{ 
							...
							<?php 
							    ...
							    if($row->type==4)
								{
									$mys_result = mysql_query("select   total_fare,booking_date from hotel_main_details where 	payee_txn_id='$row->payee_txn_id'  ");
									while($myresult  = mysql_fetch_row($mys_result))
									{ 
