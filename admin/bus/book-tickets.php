		...
		<div class="col-md-10">  
  			<div class="content-box-large">
  				<div class="panel-heading">
					<div class="panel-title"><h3> Confirmed Bus Tickets </h3></div>
  				...
  				<div class="panel-body">
  					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
						...
						<tbody>
							<?php
								  $result = mysql_query("select * from bus_tickets where user_type=0  ");
								  $sr=1; 
							...
							<tr class="odd gradeX">
								...
								<td><?php echo $row->fare;?> <img src="<?php echo ROOTPATH;?>/view/images/rupee_icon.png" /></td>
